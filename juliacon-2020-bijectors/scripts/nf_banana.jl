...
function generate_samples(batch_size)
    ...
    return vcat(x1_samples', x2_samples')
end
...
gif(anim, "../figures/nf-banana-density-estimation-new.gif", fps=10)
